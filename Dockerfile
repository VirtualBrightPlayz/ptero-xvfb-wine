...
RUN     apt update
RUN     apt install -y wget net-tools iproute2 gnupg2 xvfb pulseaudio apt-transport-https software-properties-common lib32gcc1 sudo xserver-xorg-video-dummy python3 libfreetype6:i386 libfreetype6
# libfaudio0 aptitude
